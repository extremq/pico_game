...
void Display::load_frame() {
    ...
    // Get buffers
    uint16_t * buff = this->get_buffer();
    bool * diff = this->get_diff();
    uint8_t w = this->get_width();
    uint8_t h = this->get_height();
